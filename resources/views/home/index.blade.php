  ...
  @if(Request::session()->get('username') == '')
	<div class="main">
		<div class="page page1">
			...
			<div class='page-info'>
    				<p>欢迎使用 NEUOJ ver {{ env('APP_VER', 'NULL') }},
                        {{--<a href="http://202.118.31.226:3322/Lbyang/NEUOJ"><img src="http://202.118.31.226:3322/api/badges/Lbyang/NEUOJ/status.svg" /></a>--}}
                        在使用中遇到任何问题, 点击<a href="https://github.com/NEU-ACM/OnlineJudge/issues/new">[Github Issues]</a><p>
    			</div>
